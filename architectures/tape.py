...
from architectures.transformers import MLP, TransformerDecoder, TransformerEncoder, add_vis_pos_emb
            ...
            if num_layers_per_readwrite == 0:
                ...
                if conv_kernel_size == 0:
                    ...
                    self.conv_units[str(i)] = DepthwiseConvBlock(
                        tape_dim, kernel_size=conv_kernel_size, dropout_rate=conv_drop_units, name=f"conv_units_{i}"
                    )
