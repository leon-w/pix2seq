            ...
            [
                h.product(
                    [
                        ...
                        h.sweep("config.optimization.weight_decay", [0.0]),
            ...
            [
                h.product(
                    [
                        ...
                        h.sweep(
                            "config.optimization.learning_rate_schedule", ["cosine@0.7"]
                        ),
                        ...
                        h.sweep("config.model.drop_units", [0.0]),
                        h.sweep("config.model.drop_path", [0.0]),
                    ]
                ),
            ]
        )
