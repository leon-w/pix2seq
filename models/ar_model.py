...
class Model(tf.keras.models.Model):
    ...
    def __init__(self, config: ml_collections.ConfigDict, **kwargs):
        ...
        self.proj = tf.keras.layers.Dense(config.dim_att_dec, name="proj/linear")
        self.proj_ln = tf.keras.layers.LayerNormalization(epsilon=1e-6, name="proj/ln")
...
class ModelT(Model):
    ...
    def _encode_images(self, images, training):
        ...
        config = self.config
        sub_isize = [
            config.image_size[0] // self.drate,
