...
class VideoTapeDenoiser(TapeDenoiser):  # pylint: disable=missing-docstring
    ...
    def readout_tape(self, tape):
        ...
        if out.shape[1] > out_len:
            out = out[:, :out_len]  # odd-len conv padding
        return out
    ...
    def call(self, x, t, cond, training):
        ...
        tape_cond, _ = self.initialize_tape(cond, None, None, None, offset=cond_offset)
